// Feladat: Haladó / Mohó algoritmusok / Hegy *** 
// Lezsák Domonkos
...
long long int i, j, k, l, m, n, o, p, x, y, z, a, b, c;
...
int main(){
    ...
    long long int mv=vv.back();
    fh(i, 0, m){
        long long int avail=leftover+vv[i];
        while(mv>avail){
            mv--;
            avail+=m-i-1;
        }
        leftover=avail-mv;
        cerr<<i<<" "<<mv<<"+"<<leftover<<endl;
    }
